...
public class StringValidator {
    ...
    //Возвращает индекс математического знака
    ...
    public int containsArabian(String p) {
        for (int i = 0; i < 10; i++) {
